...
public class AuthenticationService {
    ...
    static public void addToken(HttpServletResponse res, String username) {
        String JWToken = Jwts.builder().setSubject(username).setExpiration(new Date(System.currentTimeMillis() +
                EXPIRATIONTIME)).signWith(SignatureAlgorithm.HS512, SIGNINKEY).compact();
